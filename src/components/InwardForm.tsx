...
import { InwardItem } from "@/types/inward";
...
interface InwardFormProps {
  onSubmit: (items: InwardItem[], site: string, remarks: string) => void;
  onBack: () => void;
}

export function InwardForm({ onSubmit, onBack }: InwardFormProps) {
  const [searchQuery, setSearchQuery] = useState("");
  const [selectedSite, setSelectedSite] = useState("");
  const [selectedItems, setSelectedItems] = useState<Map<string, InwardItem>>(new Map());
    ...
    <div className="min-h-screen bg-background p-3 sm:p-6">
      ...
      {selectedItems.size > 0 && (
        <div className="mb-4 sm:mb-6">
          ...
          <Textarea
            placeholder="Add remarks for this inward..."
            value={remarks}
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You are about to submit an inward with {selectedItems.size} item(s).
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
